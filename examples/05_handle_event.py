...
conn.core.CreateWindow(
    ...
    [screen.white_pixel, 
     xproto.EventMask.ButtonPress | xproto.EventMask.ButtonRelease | xproto.EventMask.EnterWindow | xproto.EventMask.LeaveWindow | xproto.EventMask.Exposure | xproto.EventMask.KeyPress | xproto.EventMask.KeyRelease | xproto.EventMask.PointerMotion,
     ],
    )
...
while True:
    ...
    for attr in dir(event):
        if not attr.startswith("_"):
            print "%s: %s" % (attr, getattr(event, attr))
